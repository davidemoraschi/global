...
'*************************************************************************
'
' Global Obj for X100/X150 instruments
'
'*************************************************************************
Option Explicit
'#Uses ".\xbase.bas"
...
Public xh As Xiril100HighLevelFunctions

Public Enum eBCRLeftRight
	BCR_LEFT=1
	BCR_RIGHT=0
End Enum

Public Sub InitGlobalObjVarX100
    Set xh = New Xiril100HighLevelFunctions
    Call xh.InitLib(XToolApp, Robot, xs)
End Sub

Public Sub ClearObjX100
    Set xh = Nothing
End Sub
